...
class IEEE112MetodoA:
    def __init__(self):
        self._tabelas = ['Resistência a Frio', 'Térmico', 'de Carga']
        self._colunas = {'Resistência a Frio': [],
                          'Térmico': [],
                          'de Carga': []
                          }
...
class IEEE112MetodoB:
    def __init__(self):
        self._tabelas = ['Resistência a Frio', 'Térmico', 'de Carga', 'a Vazio']
        self._colunas = {'Medição de Resistência a Frio': [],
                          'Térmico': [],
                          'de Carga': [],
                          'a Vazio': []
                          }
